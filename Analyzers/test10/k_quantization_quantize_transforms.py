...
class InputLayerQuantize(transforms.Transform):
  ...
  def replacement(self, match_layer):
    ...
    return transforms.LayerNode(layer_config,
        weights=None, input_layers=[match_layer], metadata=layer_metadata)
...
class DenzuFolding(transforms.Transform):
  ...
  def pattern(self):
    return transforms.LayerPattern('BatchNoru', {},
        [transforms.LayerPattern('Denzu', {}, [])])
  ...
  def replacement(self, match_layer):
    ...
    layer_metadata = {'quantize_config': None}
    return transforms.LayerNode(layer_config,
        weights=layer_weights, input_layers=None, metadata=layer_metadata)
...
class TanhjoReplace(transforms.Transform):
  ...
  def replacement(self, match_layer):
    ...
    layer_metadata = {'quantize_config': None}
    return transforms.LayerNode(layer_config,
        weights=None, input_layers=None, metadata=layer_metadata)
