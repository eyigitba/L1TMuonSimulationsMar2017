...
class EMTFLayer(object):
  def __init__(self):
    ...
    _join = lambda a, b, c: (a * 100) + (b * 10) + c
    lut[1,1,4] = _join(0,0,1) # ME1/1a
    lut[1,1,1] = _join(0,0,1) # ME1/1b
    lut[1,1,2] = _join(1,0,2) # ME1/2
    lut[1,1,3] = _join(1,0,3) # ME1/3
    lut[1,2,1] = _join(2,0,1) # ME2/1
    lut[1,2,2] = _join(2,0,2) # ME2/2
    lut[1,3,1] = _join(3,0,1) # ME3/1
    lut[1,3,2] = _join(3,0,2) # ME3/2
    lut[1,4,1] = _join(4,0,1) # ME4/1
    lut[1,4,2] = _join(4,0,2) # ME4/2
    lut[2,1,2] = _join(1,1,2) # RE1/2
    lut[2,1,3] = _join(1,1,3) # RE1/3
    lut[2,2,2] = _join(2,1,2) # RE2/2
    lut[2,2,3] = _join(2,1,3) # RE2/3
    lut[2,3,1] = _join(3,1,1) # RE3/1
    lut[2,3,2] = _join(3,1,2) # RE3/2
    lut[2,3,3] = _join(3,1,3) # RE3/3
    lut[2,4,1] = _join(4,1,1) # RE4/1
    lut[2,4,2] = _join(4,1,2) # RE4/2
    lut[2,4,3] = _join(4,1,3) # RE4/3
    lut[3,1,1] = _join(0,1,1) # GE1/1
    lut[3,2,1] = _join(2,1,1) # GE2/1
    lut[4,1,1] = _join(5,0,1) # ME0
    lut[0,1,1] = _join(5,1,1) # MB1
    lut[0,2,1] = _join(5,1,2) # MB2
    lut[0,3,1] = _join(5,1,3) # MB3
    lut[0,4,1] = _join(5,1,4) # MB4
    self.lut = lut
...
class EMTFZone(object):
  def __init__(self):
    ...
    lut[1,1,4][0] = 4,26    # 001: ME1/1a
    lut[1,1,1][0] = 4,26    # 001: ME1/1b
    lut[1,2,1][0] = 4,25    # 201: ME2/1
    lut[1,3,1][0] = 4,25    # 301: ME3/1
    lut[1,4,1][0] = 4,25    # 401: ME4/1
    lut[4,1,1][0] = 4,23    # 501: ME0
    lut[3,1,1][0] = 17,26   # 011: GE1/1
    lut[3,2,1][0] = 4,25    # 211: GE2/1
    lut[2,3,1][0] = 4,25    # 311: RE3/1
    lut[2,4,1][0] = 4,25    # 411: RE4/1
    #
    lut[1,1,4][1] = 24,53   # 001: ME1/1a
    lut[1,1,1][1] = 24,53   # 001: ME1/1b
    lut[1,1,2][1] = 46,54   # 102: ME1/2
    lut[1,2,1][1] = 23,49   # 201: ME2/1
    lut[1,3,1][1] = 23,40   # 301: ME3/1
    lut[1,3,2][1] = 44,54   # 302: ME3/2
    lut[1,4,1][1] = 23,35   # 401: ME4/1
    lut[1,4,2][1] = 38,54   # 402: ME4/2
    lut[3,1,1][1] = 24,52   # 011: GE1/1
    lut[2,1,2][1] = 52,56   # 112: RE1/2
    lut[3,2,1][1] = 23,46   # 211: GE2/1
    lut[2,2,2][1] = 56,56   # 212: RE2/2
    lut[2,3,1][1] = 23,36   # 311: RE3/1
    lut[2,3,2][1] = 40,52   # 312: RE3/2
    lut[2,4,1][1] = 23,31   # 411: RE4/1
    lut[2,4,2][1] = 36,52   # 412: RE4/2
    #
    lut[1,1,2][2] = 52,88   # 102: ME1/2
    lut[1,2,2][2] = 53,88   # 202: ME2/2
    lut[1,3,2][2] = 51,88   # 302: ME3/2
    lut[1,4,2][2] = 51,88   # 402: ME4/2
    lut[2,1,2][2] = 52,84   # 112: RE1/2
    lut[2,2,2][2] = 56,76   # 212: RE2/2
    lut[2,2,3][2] = 88,88   # 213: RE2/3
    lut[2,3,2][2] = 48,60   # 312: RE3/2
    lut[2,3,3][2] = 72,84   # 313: RE3/3
    lut[2,4,2][2] = 52,52   # 412: RE4/2
    lut[2,4,3][2] = 64,84   # 413: RE4/3
    #
    lut[1,1,3][3] = 98,125  # 103: ME1/3
    lut[1,2,2][3] = 80,111  # 202: ME2/2
    lut[1,3,2][3] = 80,98   # 302: ME3/2
    lut[1,4,2][3] = 80,91   # 402: ME4/2
    lut[2,1,3][3] = 100,120 # 113: RE1/3
    lut[2,2,3][3] = 88,112  # 213: RE2/3
    lut[2,3,3][3] = 80,92   # 313: RE3/3
    #lut[2,4,3][3] = 84,84   # 413: RE4/3
    lut[0,1,1][3] = 92,130  # 511: MB1
    lut[0,2,1][3] = 108,138 # 512: MB2
    lut[0,3,1][3] = 126,144 # 513: MB3
    self.lut = lut
...
class EMTFZoneRow(object):
  def __init__(self):
    ...
    lut[4,1,1][0] = 0  # 501: ME0
    lut[3,1,1][0] = 1  # 011: GE1/1
    lut[1,1,4][0] = 2  # 001: ME1/1a
    lut[1,1,1][0] = 2  # 001: ME1/1b
    lut[3,2,1][0] = 3  # 211: GE2/1
    lut[1,2,1][0] = 4  # 201: ME2/1
    lut[1,3,1][0] = 5  # 301: ME3/1
    lut[2,3,1][0] = 6  # 311: RE3/1
    lut[1,4,1][0] = 7  # 401: ME4/1
    lut[2,4,1][0] = 8  # 411: RE4/1
    #
    lut[3,1,1][1] = 0  # 011: GE1/1
    lut[1,1,4][1] = 1  # 001: ME1/1a
    lut[1,1,1][1] = 1  # 001: ME1/1b
    lut[1,1,2][1] = 2  # 102: ME1/2
    lut[2,1,2][1] = 3  # 112: RE1/2
    lut[3,2,1][1] = 4  # 211: GE2/1
    lut[2,2,2][1] = 4  # 212: RE2/2
    lut[1,2,1][1] = 5  # 201: ME2/1
    lut[1,3,1][1] = 6  # 301: ME3/1
    lut[1,3,2][1] = 6  # 302: ME3/2
    lut[2,3,1][1] = 7  # 311: RE3/1
    lut[2,3,2][1] = 7  # 312: RE3/2
    lut[1,4,1][1] = 8  # 401: ME4/1
    lut[1,4,2][1] = 8  # 402: ME4/2
    lut[2,4,1][1] = 9  # 411: RE4/1
    lut[2,4,2][1] = 9  # 412: RE4/2
    #
    lut[1,1,2][2] = 0  # 102: ME1/2
    lut[2,1,2][2] = 1  # 112: RE1/2
    lut[2,2,2][2] = 2  # 212: RE2/2
    lut[2,2,3][2] = 2  # 213: RE2/3
    lut[1,2,2][2] = 3  # 202: ME2/2
    lut[1,3,2][2] = 4  # 302: ME3/2
    lut[2,3,2][2] = 5  # 312: RE3/2
    lut[2,3,3][2] = 5  # 313: RE3/3
    lut[1,4,2][2] = 6  # 402: ME4/2
    lut[2,4,2][2] = 7  # 412: RE4/2
    lut[2,4,3][2] = 7  # 413: RE4/3
    #
    lut[0,1,1][3] = 0  # 511: MB1
    lut[0,2,1][3] = 1  # 512: MB2
    lut[0,3,1][3] = 2  # 513: MB3
    lut[1,1,3][3] = 3  # 103: ME1/3
    lut[2,1,3][3] = 4  # 113: RE1/3
    lut[2,2,3][3] = 5  # 213: RE2/3
    lut[1,2,2][3] = 6  # 202: ME2/2
    lut[1,3,2][3] = 7  # 302: ME3/2
    lut[2,3,3][3] = 8  # 313: RE3/3
    lut[1,4,2][3] = 9  # 402: ME4/2
    #lut[2,4,3][3] = 9  # 413: RE4/3
    self.lut = lut
